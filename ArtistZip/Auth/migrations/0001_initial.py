    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='회사명')),
                ('position', models.CharField(blank=True, max_length=150, null=True, verbose_name='직책')),
